...
$(function(){
	...
	$(".play-btn").on('click', function(event) {
        ...
        $(".play-btn").each(function(index, el) {
	...
	$("audio").on('playing',function(event) {
        $(this).siblings('.play-btn').addClass('playnow');
    });
    $("audio").on('pause', function(event) {
        $(this).siblings('.play-btn').removeClass('playnow');
    });
...
function players(id,btn){
	var idT = id;
	console.log(idT);
	var audio = document.getElementById(idT);
	console.log(audio);
	//防止冒泡
